...
class ProductBrandPolicy
{
    ...
    {
        return $user->can('force_delete_product::brand');
    }
    ...
    {
        return $user->can('force_delete_any_product::brand');
    }
    ...
    {
        return $user->can('restore_product::brand');
    }
    ...
    {
        return $user->can('restore_any_product::brand');
    }
    ...
    {
        return $user->can('replicate_product::brand');
    }
    ...
    {
        return $user->can('reorder_product::brand');
    }
}
